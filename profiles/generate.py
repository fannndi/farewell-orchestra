...
Usage:  python profiles/generate.py <profile-name> [--stdout]
          python profiles/generate.py default
          python profiles/generate.py mix --stdout > opencode.jsonc
...
def generate(profile_name, to_stdout=False):
    ...
    if profile_name == "default":
        ...
        with open(_example_path, 'w', encoding='utf-8') as f:
            f.write("// Example output — generated by: python profiles/generate.py --stdout default\n")
