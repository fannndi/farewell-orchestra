...
4. **Rollback:** kalau target project nggak bisa diakses (path error) → rollback ke workspace sebelumnya tanpa crash.

5. **Konfirmasi ke Boss:** "Siap kerja di {PROJECT_NAME}. Ada request?"
